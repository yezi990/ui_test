...
module.exports = function(){
    ...
    it('click: wd ( #kw, 344, 20, 0 )', async function(){
        await driver.sleep(300).wait('#kw', 30000)
               .sleep(300).mouseMove(344, 20).click(0);
    });

    it('sendKeys: 我是', async function(){
        await driver.sendKeys('我是');
    });

    it('click: 百度一下 ( #su, 103, 28, 0 )', async function(){
        await driver.sleep(300).wait('#su', 30000)
               .sleep(300).mouseMove(103, 28).click(0);
    });

    it('expect: text, #container div.search_tool, equal, 搜索工具', async function(){
        await driver.sleep(300).wait('#container div.search_tool', 30000)
            .text()
